...
gcc -std=gnu11 -Wall -Wextra -Wbad-function-cast -Wstrict-prototypes -Wmissing-declarations -Wmissing-prototypes -Wno-unused-parameter -Werror -Werror=vla -g -pedantic ../lexer.o ../parser.o ../parsing.o ../command.c ../strextra.c test.c -o runtest_original_parse `pkg-config --cflags --libs glib-2.0` -lcheck
./runtest_original_parse "expected.txt"
...
./runtest_parse "output.txt" > test.log 2>&1
