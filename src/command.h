...
/*
 * Devuelve el n-ésimo argumento del comando simple.
 * self: comando simple a consultar.
 * n: número de argumento a consultar.
 * Requires: self!=NULL && n<scommand_length(self)
 * Ensures: result!=NULL
 */
char* scommand_nth_arg(const scommand self, unsigned int n);

/*
 * Genera un arreglo de strings con los argumentos del comando simple.
 * self: comando simple a convertir.
 * Returns: un arreglo de strings con los argumentos del comando simple.
 *   El arreglo es NULL-terminated, y cada string es una copia de los
 *   argumentos del comando simple. El llamador es dueño del arreglo y
 *   de los strings resultantes.
 * Requires: self!=NULL
 * Ensures: result!=NULL && result[scommand_length(self)]==NULL
 */
...
/*
 * Devuelve el n-ésimo comando simple del pipeline.
 * self: pipeline a consultar.
 * n: número de comando simple a consultar.
 * Requires: self!=NULL && n<pipeline_length(self)
 * Ensures: result!=NULL
 */
